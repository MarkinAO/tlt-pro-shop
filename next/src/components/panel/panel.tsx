...
export const Panel = () => {
  ...
  return (
    <div className="flex justify-between gap-1 items-center p-[10px] w-full">
      <input
        className="p-text h-[30px] w-[240px] bg-[#C9CFD8] opacity-[0.88] placeholder:text-[#888F99] p-[10px] py-[6px] block rounded-md border focus:border-[#C9CFD8] focus:bg-transparent outline-none"
        type="text"
        placeholder="Поиск"
        value={search}
